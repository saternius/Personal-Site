...
var TestYourInnerGamer = function(){
	...
	this.screenshots = ["images/projectShots/TestYourInnerGamer/Menu.png", 
						"images/projectShots/TestYourInnerGamer/game1.png",
						"images/projectShots/TestYourInnerGamer/game2.png",
						"images/projectShots/TestYourInnerGamer/game3.png",
						"images/projectShots/TestYourInnerGamer/game4.png",
						"images/projectShots/TestYourInnerGamer/game5.png",
						"images/projectShots/TestYourInnerGamer/game6.png",
						"images/projectShots/TestYourInnerGamer/game7.png",
						];
...
var FloatingBoxesOfWonder = function(){
	...
	this.screenshots = ["images/projectShots/FloatingBoxesOfWonder/Menu.png",
						"images/projectShots/FloatingBoxesOfWonder/game2.png", 
						"images/projectShots/FloatingBoxesOfWonder/game1.png",
						];
	this.embed = ['swf','images/projectShots/CCC/swf/ccc.swf','600','600']; 
	this.tags = ["Flash", "Gaming"]; 
}
...
var SpaceDexterity2 = function(){
	...
	this.screenshots = [
						//"images/projectShots/FloatingBoxesOfWonder/Menu.png",
						"images/projectShots/sd2/Menu.png",
						"images/projectShots/sd2/Game1.png", 
						"images/projectShots/sd2/Game2.png",
						"images/projectShots/sd2/Game3.png"
						];
	this.tags = ["Flash", "Gaming"]; 
}
...
var Simulator_237 = function(){
	...
	this.screenshots = [
							"images/projectShots/Sim_237/Game1.png"
					   ];						
	this.tags = ["Flash", "Gaming"]; 
}
...
var Loaded = function(){
	...
	this.screenshots = [
							"images/projectShots/Loaded/Menu.png",
							"images/projectShots/Loaded/Game1.png",
							"images/projectShots/Loaded/Game2.png",
							"images/projectShots/Loaded/Game3.png"
					   ];	
}
...
var TakeOut = function(){
	...
	this.screenshots = [
							"images/projectShots/TakeOut/Game1.png",
							"images/projectShots/TakeOut/Menu.png"
					   ];	
}
...
var Arbitrio = function(){
	...
	this.screenshots = [
							"images/projectShots/Arbitrio/Menu.png",
							"images/projectShots/Arbitrio/Game3.png",
							"images/projectShots/Arbitrio/Game1.png",
							"images/projectShots/Arbitrio/Game2.png"
					   ];	
}
...
var MyRightToPlay = function(){
	...
	this.screenshots = [
							"images/projectShots/MRTP/Menu.png"
					   ];	
}
...
var ZombieIO = function(){
	...
	this.screenshots = [
							"images/projectShots/ZombieIO/Game1.png"
					   ];	
}
...
var MrGameAndPebbleWatch = function(){
	...
	this.screenshots = [
							"images/projectShots/GameAndWatch/Game1.png"
					   ];	
}
...
var Uptalk = function(){
	...
	this.screenshots = [
							"images/projectShots/UpTalk/Menu.jpg",
							"images/projectShots/UpTalk/Game1.jpg",
							"images/projectShots/UpTalk/Game2.jpg",
							"images/projectShots/UpTalk/Game3.jpg"
					   ];	
}
...
var CobbleStone = function(){
	...
	this.screenshots = [
							"images/projectShots/CobbleStone/Menu.png",
					   ];	
}
...
var LawyerUp = function(){
	...
	this.screenshots = [
							"images/projectShots/LawyerUp/Game1.jpg"
					   ];	
}
...
var ArbCorvisa = function(){
	...
	this.screenshots = [
							"images/projectShots/ArbCorvisa/Game1.jpg"
					   ];	
}
...
var Downlowd = function(){
	...
	this.screenshots = [
							"images/projectShots/Downlowd/Game1.png"
					   ];	
...
var DotDoccer = function(){
	...
	this.screenshots = [
							"images/projectShots/Braillense/Game1.png"
					   ];	
...
var IntelliWheels = function(){
	...
	this.screenshots = [
							"images/projectShots/Intelliwheels/Game1.png",
							"images/projectShots/Intelliwheels/Menu.png",
							"images/projectShots/Intelliwheels/Game2.png",
							"images/projectShots/Intelliwheels/Game3.png"
					   ];	
}
...
var Cublet = function(){
	...
	this.screenshots = [
							"images/projectShots/Cublet/Menu.png",
					   ];	
}
...
var ThisWebsite = function(){
	...
	this.screenshots = [
							"images/projectShots/ThisWebsite/Menu.png",
					   ];	
}
...
var PokerTV = function(){
	...
	this.screenshots = [
							"images/projectShots/PokerTV/Menu.png",
					   ];	
}
...
var screenshots = [];
var disp_image_top = document.getElementById("open-project-image-top");
var disp_image_bottom = document.getElementById("open-project-image-bottom");
disp_image_bottom.style.opacity = 0;
disp_image_bottom.style.zIndex = 1;

var disp_index = 0;
setInterval(loopThroughScreenshots,3000);
function loopThroughScreenshots(){
	var i = disp_index%screenshots.length;
	//console.log(disp_index%2);
	//console.log(i);
	if(screenshots.length>1){
		if((disp_index%2)){
			
			disp_image_top.style.zIndex = 1;
			disp_image_bottom.style.zIndex = 10;
			disp_image_bottom.src = screenshots[i];
			setTimeout(function(){
				disp_image_top.style.opacity = 0;
				disp_image_bottom.style.opacity = 1;
			},2000);
			
			
		}else{
			
			disp_image_top.style.zIndex = 10;
			disp_image_bottom.style.zIndex = 1;
			disp_image_top.src = screenshots[i];
			setTimeout(function(){
				disp_image_bottom.style.opacity = 0;
				disp_image_top.style.opacity = 1;
			},2000);
		}
		disp_index++;
	}
...
function loadProject(project){
	var title = document.getElementById("open-project-title");
	var date = document.getElementById("open-project-subtitle");
	var stack = document.getElementById("open-project-stack");
	var desc = document.getElementById("open-project-desc");
	...
	stack.innerHTML = "Uses: "+tags;
	desc.innerHTML = project.desc;
	disp_image_top.src = project.screenshots[0];
	disp_image_bottom.src = project.screenshots[0];
	screenshots = project.screenshots;
	disp_index = 0;
	
	loopThroughScreenshots();
	console.log(project);
...
function loadTable(table,info,projectTitle,projectBorder,projectText,projectTag,projectTags,data){
	...
	table.style.backgroundImage = "url('"+data.screenshots[0]+"')";
